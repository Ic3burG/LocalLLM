...
- **UI:** Glass/gradient aesthetic; icon rail sidebar; `--llm-*` CSS token system; **LocalLLM** branding; Welcome screen; all prior features preserved (Deep Thinking, Starred/Recents/All Chats, Image Generation, Scheduled Tasks, Agent Trace, Tool Approval, Vitals Dashboard).
